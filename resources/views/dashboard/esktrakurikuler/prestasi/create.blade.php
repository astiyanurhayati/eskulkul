<x-master title="create">
    ...
    <div class="container ml-3">
        <div class="app-card rounded w-50 pl-4">
            <h5 class="py-2 rounded">Create Prestasi baru</h5>
        </div>
        <div class="col-8 mb-5">

            <div class="app-card  justify-content-start py-2 px-4  mb-5">
                <form action="{{url('dashboard/prestasi/store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="title">Judul</label>
                        <input type="text" name="title" class="form-control @error('title')
                            is-invalid
                        @enderror" id="title" value="{{old('title')}}" placeholder="Judul" autofocus>
                        @error('title')
                    ...
                    <div class="mt-2">
                        ...
                        <input type="hidden" name="slug" value="{{old('slug')}}" class="form-control" id="slug" placeholder="Slug" readonly>
                    </div>
                    <div class="mt-3">
