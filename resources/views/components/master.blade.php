                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                ...
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                                    <img src="{{asset('assets/img/bulat.svg')}}" alt="">
                                    {{-- @if(is_null(Auth::user()->image_profile))
                                    <img src="{{asset('assets/img/profile.png')}}" alt="" width="100">
                                    @else
                                    <img style="border-radius: 100%" src="{{asset('assets/img/'.Auth::user()->image_profile)}}" alt="" width="100">
                                    @endif --}}
                                </a>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{asset('assets/img/logoh.png')}}" alt="logo"><span class="logo-text">Eskul</span></a>
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link {{(request()->is('pembayaran')) ? 'active' : '' }}" href="{{url('dashboard/category')}}">
                                <span class="nav-icon">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{url('dashboard/eskul-siswa')}}">
                                <span class="nav-icon">
                                ...
                                <span class="nav-link-text">Eskul Siswa</span>
                            </a>
                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link" href="{{url('dashboard/student')}}">Master Student</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="{{url('dashboard/rayon')}}">Rayon</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="{{url('dashboard/rombel')}}">Rombel</a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{url('dashboard/rekap/progja')}}">
                                <span class="nav-icon">
                                ...
                                <span class="nav-link-text">Rekap Program Kerja </span>
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{url('dashboard/progja')}}">
                                <span class="nav-icon">
                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    @if(Auth::user()->role == "instructor")
                                    <li class="submenu-item"><a class="submenu-link" href="{{url('dashboard/absensi')}}">Absensi Siswa</a></li>
                                    @endif
